...
//    $("#error-gist-index-link").attr("href", "https://gist.github.com/" + gistId);
  ...
  return $.get(src, function(content) {
    ...
    if (gistId === "test") {
      ...
      description = "<a href=\"http://journal-club-adventures.github.io/\">Journal Club Adventures</a>. This is adventure <a href=\"http://journal-club-adventures.github.io/#" + gistId +"\">#" + gistId+"</a> by < href=\""+authorUrl+"\">"+author+"</a>.";
